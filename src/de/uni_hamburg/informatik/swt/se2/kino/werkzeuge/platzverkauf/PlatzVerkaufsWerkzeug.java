...
public class PlatzVerkaufsWerkzeug
{
    ...
    private void fuehreBarzahlungDurch()
    {
        ...
        BarzahlungsWerkzeug barWerkzeug = new BarzahlungsWerkzeug(preis);
        barWerkzeug.uiZeigen();

        if (barWerkzeug.getSuccess())
        {
    ...
    private void aktualisierePlatzplan()
    {
        if (_vorstellung != null)
        {
            ...
            initialisierePlatzplan(saal.getAnzahlReihen(), saal.getAnzahlSitzeProReihe());
